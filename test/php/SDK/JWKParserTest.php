...
use Tecsafe\OFCP\JWT\Types\JwtCustomer_Meta6659a82ea5bb2;
...
class JWKParserTest extends TestCase
{
    ...
    public function testParseBaseJwk()
    {
        ...
        JWKParser::parseBaseJwk(self::UNKNOWN_JWT, $this->getJWKS());
    }

    public function testParseCustomerJwk()
    {
        $jwtCustomer = JWKParser::parseCustomerJwk(self::CUSTOMER_JWT, $this->getJWKS());
